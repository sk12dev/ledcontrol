...
export function CueCard({ id, name, duration, deviceCount, previewColors }: CueCardProps) {
  return (
    <div className="bg-zinc-900/80 border border-zinc-800 rounded-lg p-4 backdrop-blur-sm hover:border-zinc-700 transition-all group">
      ...
      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
        <Button size="sm" variant="ghost" className="flex-1 text-xs text-zinc-400 hover:text-white">
        ...
        <Button size="sm" variant="ghost" className="text-xs text-zinc-400 hover:text-red-400">
